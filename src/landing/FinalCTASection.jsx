...
export function FinalCTASection() {
  return (
    <footer className="lp-section lp-final-cta">
      <div className="lp-glass lp-final-cta-panel">
        <Reveal>
        ...
        <Reveal delay={340}>
          <p className="lp-sans" style={{ fontSize: 13, color: "rgba(248,245,240,0.35)", letterSpacing: "0.08em", marginBottom: 0 }}>
            {"No account required \u00B7 Free to build \u00B7 Patent Pending"}
          </p>
        </Reveal>
      </div>
      <p className="lp-sans" style={{ fontSize: 13, color: "rgba(248,245,240,0.25)", letterSpacing: "0.06em", marginTop: 12 }}>
