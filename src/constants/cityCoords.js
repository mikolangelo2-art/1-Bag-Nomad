...
const CITY_COORDS = {
  ...
  // Disambiguation: "City, Country" keys (try these before plain city names in resolveCoord)
  'Lagos, Portugal': [-8.67, 37.1],
  'Lagos, Nigeria': [3.4, 6.5],
  'Valencia, Spain': [-0.38, 39.47],
  'Valencia, Venezuela': [-68.01, 10.16],
  'Tripoli, Libya': [13.18, 32.9],
  'Tripoli, Lebanon': [35.85, 34.44],
  'Georgetown, Malaysia': [100.33, 5.41],
  'Georgetown, Guyana': [-58.15, 6.8],
  'Córdoba, Spain': [-4.78, 37.88],
  'Cordoba, Spain': [-4.78, 37.88],
  'Córdoba, Argentina': [-64.18, -31.42],
  'Cordoba, Argentina': [-64.18, -31.42],
  'Santiago, Chile': [-70.65, -33.45],
  'Santiago, Dominican Republic': [-70.7, 19.45],
  'Portland, Oregon': [-122.68, 45.52],
  'Portland, Maine': [-70.25, 43.66],
  'Birmingham, United Kingdom': [-1.9, 52.49],
  'Birmingham, United States': [-86.8, 33.52],
