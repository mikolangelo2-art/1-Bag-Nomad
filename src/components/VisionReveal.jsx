          ...
          <div style={{animation:"fadeUp 0.5s ease"}}>
            ...
            <div style={{background:"linear-gradient(135deg,rgba(169,70,29,0.1),rgba(12,21,32,0.92))",border:"1px solid rgba(201,160,76,0.32)",borderRadius:13,padding:14,marginBottom:18,overflow:"hidden",maxWidth:"100%",boxSizing:"border-box",marginLeft:0,marginRight:0,boxShadow:"0 0 24px rgba(169,70,29,0.1)"}}>
              ...
              <div style={{display:"flex",gap:7}}>
                <input className="vision-refine-input" style={{flex:1,background:"rgba(255,255,255,0.04)",border:"1px solid rgba(245,158,11,0.15)",borderRadius:8,color:"#FFF",fontSize:isMobile?14:15,padding:isMobile?"11px":"9px 11px",fontFamily:"'Inter',system-ui,-apple-system,sans-serif",outline:"none",transition:"border-color 0.30s cubic-bezier(0.25,0.46,0.45,0.94),box-shadow 0.30s cubic-bezier(0.25,0.46,0.45,0.94)"}} value={refineInput} onChange={e=>setRefineInput(e.target.value)} onKeyDown={e=>{if(e.key==="Enter")refine();}} placeholder="Reshape your vision — more culture, less beach, different vibe..." onFocus={e=>{e.target.style.borderColor="rgba(245,158,11,0.35)";e.target.style.boxShadow="0 0 0 2px rgba(245,158,11,0.08)";}} onBlur={e=>{e.target.style.borderColor="rgba(245,158,11,0.15)";e.target.style.boxShadow="none";}}/>
