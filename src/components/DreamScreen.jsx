...
/** Traveler Brief — antique gold borders + warm cream (Trip pack-item tone); cyan/green field accents preserved */
const DREAM = {
  border: "rgba(201, 160, 76, 0.72)",
  borderHi: "rgba(201, 160, 76, 0.90)",
  borderSoft: "rgba(201, 160, 76, 0.42)",
  borderCard: "rgba(201, 160, 76, 0.38)",
  borderCardOn: "rgba(201, 160, 76, 0.55)",
  bgActive: "rgba(201, 160, 76, 0.12)",
  bgTint: "rgba(201, 160, 76, 0.08)",
  pillGlow: "0 0 12px rgba(201,160,76,0.22)",
  cardGlow: "0 0 24px rgba(201,160,76,0.14)",
  /** Trip Console pack list — desktop unowned */
  cream: "rgba(255, 242, 210, 0.88)",
  creamMuted: "rgba(255, 242, 210, 0.48)",
};
      ...
      <div className="dream-content">
        ...
        <div style={{textAlign:"center",marginBottom:isMobile?20:28,animation:"fadeUp 0.6s ease"}}>
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",marginBottom:14}}>
            ...
            {loading&&<div key={retryMsg||hintIdx} className="dream-co-architect-loading-msg" style={{fontFamily:"'Playfair Display',serif",fontSize:13,fontStyle:"italic",color:retryMsg?"rgba(201,160,76,0.75)":"rgba(255,242,210,0.55)",marginTop:10,textAlign:"center",letterSpacing:0.5}}>{retryMsg||GENERATION_HINTS[hintIdx]}</div>}
          </div>
          <div style={{minHeight:isMobile?80:110}}>
            ...
            {heroPhase>=3&&<div style={{fontFamily:"'Playfair Display',serif",fontSize:isMobile?30:44,fontWeight:300,fontStyle:"italic",color:"#c9a04c",lineHeight:1.2,marginTop:10,letterSpacing:3,animation:"slideUp 0.8s cubic-bezier(0.22,1,0.36,1) both",textShadow:"0 0 28px rgba(201,160,76,0.35)"}}>Let's go.</div>}
          </div>
        </div>
        <div style={{marginBottom:13,padding:0,width:"100%",minWidth:0,boxSizing:"border-box"}}>
          <p style={{fontFamily:"'Playfair Display',serif",fontSize:isMobile?14:17,fontWeight:100,fontStyle:"italic",color:"rgba(201,160,76,0.82)",lineHeight:1.55,margin:"0 0 12px",animation:"fadeUp 0.8s ease 0.15s both",textAlign:"center",maxWidth:640,marginLeft:"auto",marginRight:"auto"}}>Every expedition starts with a feeling — tell me what&apos;s driving yours.</p>
          <div className="vision-textarea-wrap ca-chat-input-wrap" style={{borderRadius:12,overflow:"hidden"}}>
        ...
        <div style={{marginBottom:28,borderTop:"1px solid rgba(255,255,255,0.07)",paddingTop:24,padding:"24px 0 0"}}>
          <div style={{fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontSize:13,color:DREAM.cream,letterSpacing:3,textTransform:"uppercase",marginBottom:16}}>TRAVELER BRIEF</div>
          <div style={{marginBottom:12,border:travelerGroup?`1px solid ${DREAM.borderCardOn}`:`1px solid ${DREAM.borderCard}`,borderRadius:12,padding:isMobile?"12px 14px":"14px 16px",background:"rgba(255,255,255,0.02)",transition:"border 0.3s ease, box-shadow 0.3s ease",width:"100%",boxSizing:"border-box",boxShadow:travelerGroup?DREAM.cardGlow:"none"}}>
            <div style={{fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontSize:13,color:DREAM.cream,letterSpacing:2,textTransform:"uppercase",marginBottom:8}}>WHO'S GOING</div>
            <div style={{display:"flex",flexDirection:isMobile?"column":"row",flexWrap:"wrap",gap:8}}>
              {[{id:"solo",label:"Solo"},{id:"couple",label:"Couple / 2 Friends"}].map(g=>(
                <button key={g.id} onClick={()=>setTravelerGroup(g.id)} style={{padding:"9px 18px",borderRadius:24,border:travelerGroup===g.id?`1.5px solid ${DREAM.borderHi}`:"1px solid rgba(255,255,255,0.32)",background:travelerGroup===g.id?DREAM.bgActive:"rgba(255,255,255,0.06)",color:travelerGroup===g.id?DREAM.cream:"rgba(255,255,255,0.75)",fontSize:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:travelerGroup===g.id?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:40,userSelect:"none",boxShadow:travelerGroup===g.id?DREAM.pillGlow:"0 0 6px rgba(255,255,255,0.06)",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>{g.label}</button>
              ))}
            </div>
          </div>
          <div style={{marginBottom:12,border:travelStyle?`1px solid ${DREAM.borderCardOn}`:`1px solid ${DREAM.borderCard}`,borderRadius:12,padding:isMobile?"12px 14px":"14px 16px",background:"rgba(255,255,255,0.02)",transition:"border 0.3s ease, box-shadow 0.3s ease",width:"100%",boxSizing:"border-box",boxShadow:travelStyle?DREAM.cardGlow:"none"}}>
            <div style={{fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontSize:13,color:DREAM.cream,letterSpacing:2,textTransform:"uppercase",marginBottom:8}}>YOUR TRAVEL STYLE</div>
            <div style={{display:"flex",flexDirection:isMobile?"column":"row",flexWrap:"wrap",gap:8,width:"100%"}}>
              {["First Timer","Independent Explorer","Comfort & Quality","Adventure First","Luxury"].map(s=>(
                <button key={s} onClick={()=>setTravelStyle(v=>v===s?"":s)} style={{padding:isMobile?"6px 14px":"9px 18px",borderRadius:24,border:travelStyle===s?`1.5px solid ${DREAM.borderHi}`:"1px solid rgba(255,255,255,0.32)",background:travelStyle===s?DREAM.bgActive:"rgba(255,255,255,0.06)",color:travelStyle===s?DREAM.cream:"rgba(255,255,255,0.70)",fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:travelStyle===s?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:isMobile?36:40,userSelect:"none",boxShadow:travelStyle===s?DREAM.pillGlow:"0 0 6px rgba(255,255,255,0.06)",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>{s}</button>
              ))}
            </div>
          </div>
          <div style={{marginBottom:12,border:`1px solid ${DREAM.borderCard}`,borderRadius:12,padding:isMobile?"12px 14px":"12px 16px",background:"rgba(255,255,255,0.02)",transition:"border 0.3s ease",width:"100%",boxSizing:"border-box"}}>
            <div style={{fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontSize:13,color:DREAM.cream,letterSpacing:2,textTransform:"uppercase",marginBottom:8}}>INTERESTS <span style={{fontFamily:"'Playfair Display',serif",fontStyle:"italic",fontWeight:300,color:DREAM.creamMuted,fontSize:13,textTransform:"none"}}>· optional</span></div>
            <div style={{display:"flex",flexDirection:isMobile?"column":"row",flexWrap:"wrap",gap:isMobile?8:7,width:"100%"}}>
              {(()=>{const allI=[{id:"diving",icon:"🤿",label:"Diving"},{id:"culture",icon:"🌍",label:"Culture"},{id:"vlog",icon:"🎥",label:"Vlog"},{id:"food",icon:"🍜",label:"Food & Wine"},{id:"adventure",icon:"🥾",label:"Adventure"},{id:"golf",icon:"⛳",label:"Golf"},{id:"wellness",icon:"🧘",label:"Wellness"},{id:"remote",icon:"💻",label:"Remote Work"},{id:"safari",icon:"🦁",label:"Safari"},{id:"moto",icon:"🏍️",label:"Moto"}];const visible=showAllInterests?allI:allI.filter((c,i)=>i<4||interests.includes(c.id));const hidden=allI.length-visible.length;return(<>{visible.map(c=>{const on=interests.includes(c.id);return(
                <button key={c.id} onClick={()=>setInterests(p=>on?p.filter(x=>x!==c.id):[...p,c.id])} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:on?`1.5px solid ${DREAM.borderHi}`:"1px solid rgba(255,255,255,0.30)",background:on?DREAM.bgTint:"rgba(255,255,255,0.06)",color:on?DREAM.cream:"rgba(255,255,255,0.70)",fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:on?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:isMobile?36:40,userSelect:"none",boxShadow:on?DREAM.pillGlow:"0 0 6px rgba(255,255,255,0.05)",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>{c.icon} {c.label}</button>
              );})}{!showAllInterests&&hidden>0&&<button onClick={()=>setShowAllInterests(true)} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:`1px solid ${DREAM.borderSoft}`,background:"transparent",color:DREAM.cream,fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",cursor:"pointer",minHeight:isMobile?36:40,userSelect:"none",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>+ {hidden} more</button>}{showAllInterests&&<button onClick={()=>setShowAllInterests(false)} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:`1px solid ${DREAM.borderSoft}`,background:"transparent",color:DREAM.cream,fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",cursor:"pointer",minHeight:isMobile?36:40,userSelect:"none",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>− less</button>}</>);})()}
              <button onClick={()=>setSpecialtyOpen(o=>!o)} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:specialtyInterests.length>0?`1.5px solid ${DREAM.borderHi}`:specialtyOpen?`1.5px solid ${DREAM.borderSoft}`:`1px solid ${DREAM.borderCard}`,background:specialtyInterests.length>0?DREAM.bgTint:"transparent",color:specialtyInterests.length>0?DREAM.cream:specialtyOpen?"rgba(201,160,76,0.82)":"rgba(201,160,76,0.58)",fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:specialtyInterests.length>0?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:isMobile?36:40,userSelect:"none",boxShadow:specialtyInterests.length>0?DREAM.pillGlow:"0 0 6px rgba(201,160,76,0.08)",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>✦ Specialty{specialtyInterests.length>0?` (${specialtyInterests.length})`:"..."}</button>
            </div>
            <div style={{maxHeight:specialtyOpen?300:0,overflow:specialtyOpen?"visible":"hidden",transition:"max-height 0.28s ease-out"}}>
              <div style={{marginTop:8,border:`1px solid ${DREAM.borderCard}`,borderRadius:10,padding:"12px 14px",background:"rgba(255,255,255,0.02)",maxHeight:240,overflowY:"auto",WebkitOverflowScrolling:"touch",boxShadow:"inset 0 0 0 1px rgba(201,160,76,0.06)"}}>
                <div style={{fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontSize:13,color:DREAM.cream,letterSpacing:2,marginBottom:8}}>SPECIALTY INTERESTS <span style={{fontFamily:"'Playfair Display',serif",fontStyle:"italic",fontWeight:300,color:DREAM.creamMuted,fontSize:13}}>· optional</span></div>
                <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                  {[{id:"fishing",icon:"🎣",label:"Fishing"},{id:"climbing",icon:"🧗",label:"Climbing"},{id:"skiing",icon:"🎿",label:"Skiing/Snow"},{id:"nightlife",icon:"🎉",label:"Nightlife"},{id:"music",icon:"🎵",label:"Music/Festivals"},{id:"shopping",icon:"🛍️",label:"Shopping"},{id:"wine",icon:"🍷",label:"Wine Tourism"},{id:"eco",icon:"🌿",label:"Eco Travel"},{id:"photography",icon:"🎨",label:"Photography"},{id:"camping",icon:"🏕️",label:"Camping"},{id:"yoga",icon:"🤸",label:"Yoga Retreat"},{id:"watersports",icon:"🏄",label:"Water Sports"}].map(c=>{const on=specialtyInterests.includes(c.id);return(
                    <button key={c.id} onClick={()=>setSpecialtyInterests(p=>on?p.filter(x=>x!==c.id):[...p,c.id])} style={{padding:"5px 12px",borderRadius:20,border:on?`1.5px solid ${DREAM.borderHi}`:"1px solid rgba(255,255,255,0.30)",background:on?DREAM.bgTint:"rgba(255,255,255,0.06)",color:on?DREAM.cream:"rgba(255,255,255,0.68)",fontSize:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:on?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:40,userSelect:"none",boxShadow:on?DREAM.pillGlow:"0 0 5px rgba(255,255,255,0.05)"}}>{c.icon} {c.label}</button>
                  );})}
                </div>
              </div>
            </div>
        ...
        <div style={{marginBottom:22}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:7}}>
            {[{id:"dream",icon:"💭",label:"Build the dream",sub:"We'll figure budget later",accent:"#c9a04c"},{id:"rough",icon:"💰",label:"I have a rough number",sub:"Give me a ballpark",accent:"#c9a04c"},{id:"strict",icon:"🎯",label:"Keep it under...",sub:"I have a firm limit",accent:"#A29BFE"}].map(b=>(
              <button key={b.id} onClick={()=>setBudgetMode(b.id)} style={{display:"flex",alignItems:"center",gap:10,padding:"12px 13px",borderRadius:9,border:budgetMode===b.id?`1px solid ${b.accent}99`:`1px solid ${DREAM.borderCard}`,background:budgetMode===b.id?b.accent+"14":"rgba(255,255,255,0.06)",cursor:"pointer",textAlign:"left",transition:"all 0.35s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:44,width:"100%",boxSizing:"border-box",boxShadow:budgetMode===b.id?(b.id==="strict"?"0 0 22px rgba(162,155,254,0.2),0 0 0 1px rgba(162,155,254,0.18)":"0 0 20px rgba(201,160,76,0.18),0 0 0 1px rgba(201,160,76,0.12)"):"inset 0 1px 0 rgba(201,160,76,0.08),inset 0 -1px 0 rgba(0,0,0,0.2)"}}>
                <span style={{fontSize:16}}>{b.icon}</span>
                <div><div style={{fontSize:isMobile?13:14,fontWeight:700,color:budgetMode===b.id?(b.id==="strict"?b.accent:DREAM.cream):"#FFF"}}>{b.label}</div><div style={{fontSize:isMobile?12:13,color:"rgba(255,255,255,0.5)",marginTop:2}}>{b.sub}</div></div>
                <div style={{marginLeft:"auto",width:14,height:14,borderRadius:"50%",border:`1.5px solid ${budgetMode===b.id?b.accent:"rgba(255,255,255,0.15)"}`,background:budgetMode===b.id?b.accent+"33":"transparent",display:"flex",alignItems:"center",justifyContent:"center"}}>
        ...
        {loadError&&<div role="button" tabIndex={0} onClick={()=>{if(!loading)handleReveal();}} onKeyDown={e=>{if((e.key==="Enter"||e.key===" ")&&!loading){e.preventDefault();handleReveal();}}} style={{marginTop:12,padding:"12px 14px",borderRadius:10,background:"#0f0d0b",border:`1px solid ${DREAM.borderSoft}`,textAlign:"center",fontSize:14,color:DREAM.cream,letterSpacing:0.5,cursor:loading?"wait":"pointer",fontFamily:"'Inter',system-ui,-apple-system,sans-serif",lineHeight:1.45}}>{loadErrorMsg||"Could not build expedition — tap to try again"}</div>}
        <div style={{textAlign:"center",marginTop:30,paddingTop:20,borderTop:"1px solid rgba(0,229,255,0.1)"}}>
          <div style={{fontFamily:"'Playfair Display',serif",fontSize:15,fontWeight:300,fontStyle:"italic",color:"rgba(201,160,76,0.4)",letterSpacing:2}}>Dream Big. Travel Light.</div>
