      ...
      <div className="dream-content">
        ...
        <div style={{textAlign:"center",marginBottom:isMobile?20:28,animation:"fadeUp 0.6s ease"}}>
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",marginBottom:14}}>
            ...
            {loading&&<div key={retryMsg||hintIdx} className="dream-co-architect-loading-msg" style={{fontFamily:"'Playfair Display',serif",fontSize:13,fontStyle:"italic",color:retryMsg?"rgba(201,160,76,0.75)":"rgba(255,159,67,0.65)",marginTop:10,textAlign:"center",letterSpacing:0.5}}>{retryMsg||GENERATION_HINTS[hintIdx]}</div>}
          </div>
          <div style={{minHeight:isMobile?80:110}}>
            ...
            {heroPhase>=3&&<div style={{fontFamily:"'Playfair Display',serif",fontSize:isMobile?30:44,fontWeight:300,fontStyle:"italic",color:"#c9a04c",lineHeight:1.2,marginTop:10,letterSpacing:3,animation:"slideUp 0.8s cubic-bezier(0.22,1,0.36,1) both",textShadow:"0 0 24px rgba(0,120,255,0.25)"}}>Let's go.</div>}
          </div>
        </div>
        ...
        <div style={{marginBottom:28,borderTop:"1px solid rgba(255,255,255,0.07)",paddingTop:24,padding:"24px 0 0"}}>
          ...
          <div style={{marginBottom:12,border:travelStyle?"1px solid rgba(255,159,67,0.20)":"1px solid rgba(255,255,255,0.08)",borderRadius:12,padding:isMobile?"12px 14px":"14px 16px",background:"rgba(255,255,255,0.02)",transition:"border 0.3s ease",width:"100%",boxSizing:"border-box"}}>
            ...
            <div style={{display:"flex",flexDirection:isMobile?"column":"row",flexWrap:"wrap",gap:8,width:"100%"}}>
              {["First Timer","Independent Explorer","Comfort & Quality","Adventure First","Luxury"].map(s=>(
                <button key={s} onClick={()=>setTravelStyle(v=>v===s?"":s)} style={{padding:isMobile?"6px 14px":"9px 18px",borderRadius:24,border:travelStyle===s?"1.5px solid rgba(255,159,67,0.90)":"1px solid rgba(255,255,255,0.32)",background:travelStyle===s?"rgba(255,159,67,0.10)":"rgba(255,255,255,0.06)",color:travelStyle===s?"#c9a04c":"rgba(255,255,255,0.70)",fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:travelStyle===s?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:isMobile?36:40,userSelect:"none",boxShadow:travelStyle===s?"0 0 10px rgba(255,159,67,0.25)":"0 0 6px rgba(255,255,255,0.06)",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>{s}</button>
              ))}
            </div>
          </div>
          <div style={{marginBottom:12,border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:isMobile?"12px 14px":"12px 16px",background:"transparent",transition:"border 0.3s ease",width:"100%",boxSizing:"border-box"}}>
            ...
            <div style={{display:"flex",flexDirection:isMobile?"column":"row",flexWrap:"wrap",gap:isMobile?8:7,width:"100%"}}>
              ...
              <button onClick={()=>setSpecialtyOpen(o=>!o)} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:specialtyInterests.length>0?"1.5px solid rgba(201,160,76,0.90)":specialtyOpen?"1.5px solid rgba(201,160,76,0.55)":"1px solid rgba(201,160,76,0.40)",background:specialtyInterests.length>0?"rgba(201,160,76,0.08)":"transparent",color:specialtyInterests.length>0?"#c9a04c":specialtyOpen?"rgba(201,160,76,0.75)":"rgba(201,160,76,0.60)",fontSize:isMobile?12:13,fontFamily:"'Inter',system-ui,-apple-system,sans-serif",fontWeight:specialtyInterests.length>0?600:400,cursor:"pointer",transition:"all 0.30s cubic-bezier(0.25,0.46,0.45,0.94)",minHeight:isMobile?36:40,userSelect:"none",boxShadow:specialtyInterests.length>0?"0 0 10px rgba(201,160,76,0.25)":"0 0 6px rgba(201,160,76,0.10)",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>✦ Specialty{specialtyInterests.length>0?` (${specialtyInterests.length})`:"..."}</button>
            </div>
        ...
        <div style={{marginBottom:22}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:7}}>
            {[{id:"dream",icon:"💭",label:"Build the dream",sub:"We'll figure budget later",accent:"#FF9F43"},{id:"rough",icon:"💰",label:"I have a rough number",sub:"Give me a ballpark",accent:"#c9a04c"},{id:"strict",icon:"🎯",label:"Keep it under...",sub:"I have a firm limit",accent:"#A29BFE"}].map(b=>(
