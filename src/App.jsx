...
@media(max-width:599px){.dream-content{padding:14px 0 80px;width:100%;max-width:100%;margin:0;box-sizing:border-box}.goal-grid{gap:7px}.mc-content{padding:10px 12px}}
        ...
        <div style={{marginBottom:28,borderTop:"1px solid rgba(255,255,255,0.07)",paddingTop:24,padding:"24px 0 0"}}>
          ...
          <div style={{marginBottom:12,border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:isMobile?"12px 0":"12px 16px",background:"transparent",transition:"border 0.3s ease",width:"100%",boxSizing:"border-box"}}>
            ...
            <div style={{display:"flex",flexDirection:isMobile?"column":"row",flexWrap:"wrap",gap:isMobile?8:7,width:"100%"}}>
              ...
              );})}{!showAllInterests&&hidden>0&&<button onClick={()=>setShowAllInterests(true)} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:"1px solid rgba(255,255,255,0.20)",background:"transparent",color:"rgba(255,255,255,0.50)",fontSize:isMobile?12:13,fontFamily:"'Space Mono',monospace",cursor:"pointer",minHeight:isMobile?36:40,userSelect:"none",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>+ {hidden} more</button>}{showAllInterests&&<button onClick={()=>setShowAllInterests(false)} style={{padding:isMobile?"5px 11px":"6px 14px",borderRadius:20,border:"1px solid rgba(255,255,255,0.20)",background:"transparent",color:"rgba(255,255,255,0.50)",fontSize:isMobile?12:13,fontFamily:"'Space Mono',monospace",cursor:"pointer",minHeight:isMobile?36:40,userSelect:"none",width:isMobile?"100%":undefined,boxSizing:"border-box",textAlign:"center"}}>− less</button>}</>);})()}
