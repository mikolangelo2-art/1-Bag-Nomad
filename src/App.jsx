...
function getDefaultPack() {
  const t = Date.now();
  return [
    {id:t+1, name:"Peak Design 45L Backpack",    cat:"travel", cost:299,weight:4.5, volume:0,   bag:"Backpack",         owned:true},
    {id:t+2, name:"Topo Design Global Briefcase", cat:"travel", cost:150,weight:2.2, volume:0,   bag:"Global Briefcase", owned:false},
    ...
    {id:t+10,name:"Peak Design (M) Packing Cube", cat:"clothes",cost:0,  weight:0.22,volume:8,   bag:"Backpack",         owned:true},
    ...
    <div className="mc-root" style={{animation:"consoleIn 0.38s cubic-bezier(0.34,1.56,0.64,1) both"}}>
      ...
      {!isFullscreen&&<div style={{padding:isMobile?"8px 12px 6px":"10px 16px 8px",background:isMobile?"rgba(0,8,16,0.10)":"linear-gradient(180deg,rgba(21,15,10,0.98),rgba(21,15,10,0.99))",borderBottom:"1px solid rgba(232,220,200,0.06)",position:"relative",overflow:"hidden",zIndex:1}}>
        ...
        {isMobile?(()=>{
          ...
          <div data-coach="trip-stats" style={{background:'rgba(0,8,16,0.65)',backdropFilter:'blur(8px)',WebkitBackdropFilter:'blur(8px)',border:'1px solid rgba(0,229,255,0.10)',borderRadius:12,padding:'4px 0',overflow:'hidden'}}>
