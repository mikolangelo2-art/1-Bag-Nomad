        ...
        <div style={{marginBottom:24,borderTop:"1px solid rgba(255,255,255,0.06)",paddingTop:20}}>
          ...
          <div>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
              ...
              <button onClick={()=>setSpecialtyOpen(o=>!o)} style={{padding:"5px 11px",borderRadius:16,border:specialtyInterests.length>0?"1px solid rgba(255,159,67,0.7)":specialtyOpen?"1px solid rgba(255,159,67,0.5)":"1px solid rgba(255,255,255,0.15)",background:specialtyInterests.length>0?"rgba(255,159,67,0.08)":"transparent",color:specialtyInterests.length>0?"#FF9F43":specialtyOpen?"rgba(255,159,67,0.7)":"rgba(255,255,255,0.45)",fontSize:isMobile?12:13,fontFamily:"'Space Mono',monospace",fontWeight:600,cursor:"pointer",transition:"all 0.2s",minHeight:32}}>✦ Specialty{specialtyInterests.length>0?` (${specialtyInterests.length})`:"..."}</button>
            </div>
            <div style={{maxHeight:specialtyOpen?300:0,overflow:"hidden",transition:"max-height 0.3s ease"}}>
              <div style={{paddingTop:10}}>
                <div style={{fontFamily:"'Space Mono',monospace",fontSize:10,color:"rgba(255,255,255,0.35)",letterSpacing:2,marginBottom:6}}>SPECIALTY INTERESTS · <span style={{fontFamily:"'Fraunces',serif",fontStyle:"italic",fontWeight:300}}>optional</span></div>
                <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                  {[{id:"fishing",icon:"🎣",label:"Fishing"},{id:"climbing",icon:"🧗",label:"Climbing"},{id:"skiing",icon:"🎿",label:"Skiing/Snow"},{id:"nightlife",icon:"🎉",label:"Nightlife"},{id:"music",icon:"🎵",label:"Music/Festivals"},{id:"wine",icon:"🍷",label:"Wine Tourism"},{id:"eco",icon:"🌿",label:"Eco Travel"},{id:"photography",icon:"🎨",label:"Photography"},{id:"camping",icon:"🏕️",label:"Camping"},{id:"yoga",icon:"🤸",label:"Yoga Retreat"},{id:"watersports",icon:"🏄",label:"Water Sports"}].map(c=>{const on=specialtyInterests.includes(c.id);return(
                    <button key={c.id} onClick={()=>setSpecialtyInterests(p=>on?p.filter(x=>x!==c.id):[...p,c.id])} style={{padding:"5px 11px",borderRadius:16,border:on?"1px solid rgba(255,159,67,0.7)":"1px solid rgba(255,255,255,0.15)",background:on?"rgba(255,159,67,0.08)":"transparent",color:on?"#FF9F43":"rgba(255,255,255,0.45)",fontSize:isMobile?12:13,fontFamily:"'Space Mono',monospace",fontWeight:600,cursor:"pointer",transition:"all 0.2s",minHeight:32}}>{c.icon} {c.label}</button>
                  );})}
                </div>
              </div>
            </div>
