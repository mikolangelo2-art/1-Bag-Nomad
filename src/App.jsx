...
@media(max-width:599px){.dream-content{padding:14px 4px 80px;width:100%;box-sizing:border-box}.goal-grid{gap:7px}.mc-content{padding:10px 12px}}
      ...
      <div className="dream-content">
        ...
        <div style={{marginBottom:28,borderTop:"1px solid rgba(255,255,255,0.07)",paddingTop:24}}>
          ...
          <div style={{marginBottom:12,border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:isMobile?"12px 8px":"12px 16px",background:"transparent",transition:"border 0.3s ease",width:"100%",boxSizing:"border-box"}}>
            ...
            <div style={{display:isMobile?"grid":"flex",gridTemplateColumns:isMobile?"1fr 1fr":undefined,flexWrap:isMobile?undefined:"wrap",gap:isMobile?8:7,width:"100%"}}>
