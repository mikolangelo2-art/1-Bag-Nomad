    ...
    <div style={{fontFamily:"'Space Mono',monospace",background:"radial-gradient(ellipse at 20% 0%,#2d1200 0%,#1a0900 28%,#0d0500 58%,#060200 100%)",minHeight:"100vh",color:"#FFF",display:"flex",flexDirection:"column"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8}}>
          <div style={{background:"rgba(21,101,255,0.06)",border:"1px solid rgba(77,159,255,0.25)",borderRadius:8,padding:"8px 10px"}}>
            <div style={{display:"flex",alignItems:"center",gap:4,marginBottom:5}}>
              <div style={{fontSize:7,fontWeight:700,color:"#4D9FFF",letterSpacing:1.5,fontFamily:"'Space Mono',monospace",whiteSpace:"nowrap"}}>⚖️ WEIGHT</div>
            ...
            <div style={{display:"flex",alignItems:"baseline",gap:3,marginBottom:5}}><div style={{fontSize:isMobile?24:28,fontWeight:900,color:"#69F0AE",lineHeight:1,letterSpacing:-1,fontFamily:"'Space Mono',monospace"}}>{(bpW*wM).toFixed(1)}</div><div style={{fontSize:10,color:"rgba(77,159,255,0.8)",fontWeight:700}}>{unit}</div><div style={{fontSize:9,color:"rgba(255,255,255,0.65)",marginLeft:2}}>/ {wLim}</div></div>
          ...
          {(()=>{
            ...
            return(<div style={{background:"rgba(169,70,29,0.08)",border:"1px solid rgba(196,87,30,0.52)",borderRadius:8,padding:"8px 10px"}}>
              <div style={{display:"flex",alignItems:"center",gap:4,marginBottom:5}}>
                <div style={{fontSize:7,fontWeight:700,color:"#FFD93D",letterSpacing:1.5,fontFamily:"'Space Mono',monospace",whiteSpace:"nowrap"}}>📦 VOLUME</div>
              ...
              <div style={{display:"flex",alignItems:"baseline",gap:3,marginBottom:5}}><div style={{fontSize:isMobile?24:28,fontWeight:900,color:"#FFD93D",lineHeight:1,letterSpacing:-1,fontFamily:"'Space Mono',monospace"}}>{dV.toFixed(1)}</div><div style={{fontSize:10,color:"rgba(255,217,61,0.8)",fontWeight:700}}>L</div><div style={{fontSize:9,color:"rgba(255,255,255,0.65)",marginLeft:2}}>/ {VL}L</div></div>
      ...
      <div style={{display:"flex",flex:1,overflow:"hidden",minHeight:0}}>
        {!isMobile&&<div style={{display:"flex",flexDirection:"column",gap:1,padding:"8px 5px",borderRight:"1px solid rgba(169,70,29,0.3)",flexShrink:0,minWidth:108,background:"rgba(15,5,0,0.6)"}}>
          {CATS.map(c=><button key={c.id} onClick={()=>setFilterCat(c.id)} style={{display:"flex",alignItems:"center",gap:6,padding:"6px 8px",borderRadius:5,border:"none",background:filterCat===c.id?"rgba(169,70,29,0.25)":"transparent",cursor:"pointer",textAlign:"left",borderLeft:filterCat===c.id?"2px solid "+c.color:"2px solid transparent"}}><span style={{fontSize:12}}>{c.icon}</span><span style={{fontSize:10,color:filterCat===c.id?c.color:"rgba(255,255,255,0.75)",fontFamily:"'Space Mono',monospace",fontWeight:filterCat===c.id?700:400}}>{c.label}</span></button>)}
        </div>}
        <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0}}>
          ...
          {packTab==="pack"&&(
            <div style={{overflowY:"auto",flex:1}}>
              {!isMobile&&<div style={{display:"grid",gridTemplateColumns:"22px 1fr 85px 60px 60px 70px 60px 22px",gap:3,padding:"5px 10px",background:"rgba(169,70,29,0.15)",borderBottom:"1px solid rgba(196,87,30,0.6)",position:"sticky",top:0,zIndex:5}}>{["","ITEM","CAT","WEIGHT","COST","BAG","STATUS",""].map((h,i)=><div key={i} style={{fontSize:10,color:"rgba(255,159,67,0.7)",letterSpacing:1.5,fontWeight:700,textAlign:["","left","center","right","right","center","center","left"][i]}}>{h}</div>)}</div>}
