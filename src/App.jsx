...
@keyframes visionGlow{0%,100%{box-shadow:0 0 0 1px rgba(255,217,61,0.18),0 0 22px rgba(169,70,29,0.22),0 0 40px rgba(255,217,61,0.06),inset 0 0 18px rgba(0,0,0,0.18)}50%{box-shadow:0 0 0 1px rgba(255,217,61,0.32),0 0 30px rgba(169,70,29,0.28),0 0 48px rgba(255,217,61,0.1),inset 0 0 22px rgba(0,0,0,0.22)}}
...
.vision-ta{width:100%;max-width:100%;min-width:0;box-sizing:border-box;display:block;background:rgba(169,70,29,0.18)!important;border:1px solid rgba(255,217,61,0.35)!important;border-radius:12px;color:#FFF;font-size:12px;padding:14px 16px;font-family:'Inter',system-ui,-apple-system,sans-serif;resize:none;outline:none;line-height:1.8;min-height:106px;transition:border-color 0.3s,box-shadow 0.3s;margin-bottom:6px;word-break:normal;overflow-wrap:break-word;white-space:pre-wrap;box-shadow:0 0 24px rgba(169,70,29,0.2),inset 0 0 22px rgba(0,0,0,0.22)}
.vision-ta::placeholder{font-family:'Playfair Display',serif;font-style:italic;font-weight:300;font-size:15px;line-height:1.6;color:rgba(255,255,255,0.28);letter-spacing:0.01em}.vision-ta:focus{border:1px solid rgba(255,217,61,0.65)!important;animation:none!important;box-shadow:0 0 0 2px rgba(255,217,61,0.12),0 0 28px rgba(169,70,29,0.28),inset 0 0 24px rgba(0,0,0,0.25)}
...
input::placeholder,textarea::placeholder{color:rgba(255,255,255,0.45)!important;font-style:italic}.ca-chat-input::placeholder,.vision-refine-input::placeholder{font-family:'Inter',system-ui,-apple-system,sans-serif!important;font-size:14px!important;color:rgba(255,255,255,0.4)!important;font-style:normal!important}.build-root .ca-chat-input,.dream-root .vision-refine-input,[data-ca-drawer] .ca-chat-input{background-color:#0C1520!important;-webkit-appearance:none!important;appearance:none!important}input[type="date"]{-webkit-appearance:none;appearance:none}input[type="date"]::-webkit-calendar-picker-indicator{opacity:0;width:28px;cursor:pointer;position:relative;z-index:2}
...
.mc-root{font-family:var(--lux-font-body,'Inter',system-ui,-apple-system,sans-serif);background:radial-gradient(ellipse at 50% 0%,rgba(0,229,255,0.06) 0%,transparent 55%) no-repeat fixed,var(--lux-bg-trip,#171b20);min-height:100vh;color:var(--lux-text-primary,#f8f5f0);display:flex;flex-direction:column}
